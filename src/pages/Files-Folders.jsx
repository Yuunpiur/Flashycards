...
function FilesFolder() {
    ...
    function askFolder(){ 
        ...
        return (folderName == "")? "Unnamed Folder": folderName;
    }

    const addFolder = () => {setItems([...items, askFolder()])};

    return (
        <>
            <div className="selection-bar">
                <div className="bar-group1">
                    <div className="files-folders-button" onClick={addFolder}>
